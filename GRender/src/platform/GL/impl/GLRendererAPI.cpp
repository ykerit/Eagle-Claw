...
namespace GRender
{
                           ...
                           const void* userParam)
    {
        switch (severity)
        {
            case GL_DEBUG_SEVERITY_HIGH: GD_CORE_DEBUG(msg); return;
            case GL_DEBUG_SEVERITY_MEDIUM: GD_CORE_ERROR(msg); return;
            case GL_DEBUG_SEVERITY_LOW: GD_CORE_WARN(msg); return;
            case GL_DEBUG_SEVERITY_NOTIFICATION: GD_CORE_TRACE(msg); return;
        }
